...
<script>
  import message from './loginmessage.vue'
  import password from './loginpassword.vue'
  export default{
      data(){
          return{
            num1: 1,
...
<style lang="less">
  body{
    font-size: .5rem!important;background: #ffffff;
      #login{
        display: flex;justify-content: center;align-items: center;padding: 1.3rem 0 0 0;margin: 0 0 1rem 0;
      }
    #form-list{
      width: 50%;margin: 0 auto;height: 1rem;
      li{
        float: left;font-size: .4rem;margin: 0 0 0 .6rem;
      }
      .color{
        color: #00aaff;
      }
    ...
    .form{
      width: 80%;height: 700px;margin: 0 auto;
      input{
        width: 100%;height: 125px;border-radius: 10px;outline-color: #00aaff;border: 1px solid #ddd;text-indent: .4rem;font-size: .4rem;margin: 0 0 .5rem 0 ;
      }
      #title{
        width: 90%;margin: 0 auto;font-size: .4rem;color: #999;
      }
      .SubmitButton-2wG4T {
        display: block;
        width: 100%;
